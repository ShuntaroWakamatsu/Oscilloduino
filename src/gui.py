# This is the GUI file for the OScilloduino Oscilloscope
...
class MPLCanvas(FigureCanvas):
    def __init__(self, parent=None, width=5, height=4, dpi=100):
        ...
        self.axes = fig.add_subplot(111) #The position of the subplot is col-1, row-1, index-1
        super(MPLCanvas, self).__init__(fig)
        fig.tight_layout()
        
class Oscilloduino_APP(QtWidgets.QMainWindow):
    def __init__(self):
    ...
    def update_down_samples(self,value):
    ...
    def update_plot(self):
        try:
            ...
            while True:
                ...
                self.plotdata[-shift:,:] = dataself.ydata = self.plotdata[:]
